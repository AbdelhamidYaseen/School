...
namespace LaboOefeningen
{
    public class TextCellMetRandom
    {
        ...
        public static string WaardeVanCel(string waarde, string[] rooster) {
            ...
            // dit is niet de enige plaats waar je deze aanpassing kan doen
            // maar met deze aanpak kan je rand() ook in formules gebruiken
            else if (waarde == "rand()") {
                Random randomGenerator = new Random();
                return Convert.ToString(randomGenerator.Next(1,11));
            }
            else {
